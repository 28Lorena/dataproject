...
holiday = {"Destination": ["CountryA", "CountryB", "CountryC", "CountryD", "CountryE", "CountryF", "CountryG", "CountryH", "CountryI", "CountryJ", "CountryK", "CountryL", "CountryM", "CountryN", "CountryO"],
          ...
          "Star_Rating": [8.5, 3.0, 3.8, 4.4, 4.0, 4.7, 4.1, 4.0, 4.2, 9.3 , 4.0, 8.3, 4.6, 4.5, 3.9],
...
destinations = pd.read_csv("ign.csv")

filter = destinations ["Star Rating"] > 8

highest = destinations[filter]
